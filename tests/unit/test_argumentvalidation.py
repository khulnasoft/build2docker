...
def test_image_name_fail(temp_cwd):
    """
    Test to check if build2docker throws image_name validation error on --image-name argument containing
...
def test_image_name_underscore_fail(temp_cwd):
    """
    Test to check if build2docker throws image_name validation error on --image-name argument starts with _.
    """
...
def test_image_name_double_dot_fail(temp_cwd):
    """
    Test to check if build2docker throws image_name validation error on --image-name argument contains consecutive dots.
    """
...
def test_image_name_valid_restircted_registry_domain_name_fail(temp_cwd):
    """
    Test to check if build2docker throws image_name validation error on -image-name argument being invalid. Based on the
...
def test_image_name_valid_registry_domain_name_success(temp_cwd):
    """
    Test to check if build2docker runs with a valid --image-name argument.
    """
...
def test_volume_no_build_fail(temp_cwd):
    """
    Test to check if build2docker fails when both --no-build and -v arguments are given
    """
...
def test_volume_no_run_fail(temp_cwd):
    """
    Test to check if build2docker fails when both --no-run and -v arguments are given
    """
...
def test_env_no_run_fail(temp_cwd):
    """
    Test to check if build2docker fails when both --no-run and -e arguments are given
    """
...
def test_port_mapping_no_run_fail(temp_cwd):
    """
    Test to check if build2docker fails when both --no-run and --publish arguments are specified.
    """
...
def test_all_ports_mapping_no_run_fail(temp_cwd):
    """
    Test to check if build2docker fails when both --no-run and -P arguments are specified.
    """
    args_list = ["--no-run", "-P"]
