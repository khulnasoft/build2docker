"""
Tests for build2docker/utils.py
"""
...
from build2docker import utils
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("file://subdir", True),
        ("file://./subdir", True),
        ("git://github.com/khulnasoft/build2docker", False),
        ("git+https://github.com/khulnasoft/build2docker", False),
        ("numpy", False),
        ("# -e .", False),
        ("--pre", False),
