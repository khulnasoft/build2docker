...
from build2docker.contentproviders.base import ContentProviderException
from build2docker.contentproviders.doi import DoiProvider
...
def test_url_headers(requests_mock):
    ...
    assert result.request.headers["User-Agent"] == f"build2docker {__version__}"
