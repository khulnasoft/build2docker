...
extlinks = {
    "issue": ("https://github.com/khulnasoft/build2docker/issues/%s", "Issue #%s"),
    "pr": ("https://github.com/khulnasoft/build2docker/pull/%s", "PR #%s"),
...
version = build2docker.__version__
# The full version, including alpha/beta/rc tags.
release = version

from build2docker.buildpacks.conda import CondaBuildPack
...
html_theme_options = {
    ...
    "github_url": "https://github.com/khulnasoft/build2docker",
}
html_context = {
    "github_user": "jupyterhub",
    "github_repo": "build2docker",
    "github_version": "main",
...
linkcheck_ignore = [
    ...
    "https://github.com/khulnasoft/build2docker/pull/",  # too many PRs in changelog
    "https://github.com/khulnasoft/build2docker/compare/",  # too many comparisons in changelog
]
